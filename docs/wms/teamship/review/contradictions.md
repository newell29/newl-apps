...
| C03 | Narration 00:24:34-00:24:59 versus visual frames 0026/0029/0033-0036 | Whisper captured a Bixolon `SRP 770II`; the UI shows `BIXOLON SRP-770III - BF` or a related queue suffix. | Preserve both. Use the visual label only as a Draft observation. | Alex/CSR confirms exact queue and hardware. |
