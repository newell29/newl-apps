...
4. The worker runs at most five targeted Brave identity/brand/parent/geography queries and returns at most 20 unique HTTPS title/snippet records. A bounded distinctive-tail recovery query handles legal-owner and facility names whose operating brand omits a leading qualifier. Search credentials stay on the Mac.
