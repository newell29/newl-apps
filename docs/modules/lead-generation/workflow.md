...
4. Discovery remains bounded to 40 selected results per day: 24 warehousing, 12 ocean/air, and 4 trucking. Brave searches use the trailing-month freshness filter. Canonical URLs seen during the prior 180 days are removed before Qwen, and same-company/signal/geography coverage in one publication month is grouped into one event with up to eight retained public sources.
