...
Traffic changes of at least ten clicks/sessions, at least 25%, and a baseline of at least twenty are investigation hints. Conflicting sources show Mixed. Small counts show Insufficient evidence. Exposure with at least one hundred impressions, CTR below 2% and position at most twenty prompts intent/query/competition investigation. These are implementation triage defaults, not owner-approved success thresholds or statistical significance. They never create or authorize a rewrite. Direction is based on clicks/sessions, not a claim about qualified demand.
