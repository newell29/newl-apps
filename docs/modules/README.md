...
Discovered modules: `assistant`, `agent-operations`, `lead-generation`, `ups-tools`, `ltl-rate-portal`, `shipment-documents`, `invoice-automation`, `customer-cashflow`, `credit-checks`, `ocean-freight-pricing`, `website-inbound`, `website-growth`, `settings-access-control`, `operations-logs`.
