...
- Reviewing Garland feedback, linking saved-review evidence, and attaching a PDF/image require an authenticated administrator with Shipment Documents access; attachments are tenant-scoped and size/type/signature validated.
