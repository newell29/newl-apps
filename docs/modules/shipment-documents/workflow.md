...
- Targeted Garland PS/SR retrieval can scan up to 100 Teamship list pages (50,000 rows at the default page size), independently of the smaller daily-list ceiling. It stops as soon as every exact pair is confirmed. This prevents newly created orders from being reported missing solely because Teamship returned them after the first 15,000 rows.
