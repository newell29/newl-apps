...
- Carrier-manifest carrier tests recognize the printed `CLARKE` carrier value, generate the same editable workbook layout, store separate Clarke bytes and counts, and enforce tenant-scoped Clarke history and downloads.
