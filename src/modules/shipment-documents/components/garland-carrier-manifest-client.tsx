    ...
    try {
      ...
      setStatus(
        nextWorkbooks.length > 0
          ...
          : "No Midland, Speedy, Suretrack, Clarke, Guilbault Transport, or Rosedale BOLs were found in this upload."
      );
    } catch (buildError) {
                    ...
                    <tr key={run.id}>
                      ...
                      <td className="px-3 py-3 align-top">
                        <div className="flex flex-wrap gap-2">
                          ...
                          {run.hasRosedaleWorkbook ? <DownloadLink runId={run.id} type="rosedale" label="Rosedale XLS" /> : null}
                          <button
                            type="button"
