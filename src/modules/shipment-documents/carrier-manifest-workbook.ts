...
export function buildCarrierManifestWorkbookHtml({
  ...
  return [
    ...
    "col.row-number-col{width:0.36in;}col.sr-col{width:2.45in;}col.ps-col{width:1.15in;}col.city-col{width:2.35in;}col.skids-col{width:0.72in;}col.time-in-col{width:1.65in;}col.time-out-col{width:1.67in;}",
    ...
    ".column-header .row-number,.column-header .skids,.column-header .time-entry{text-align:center;}",
    ...
    "<body>",
    "<table>",
    '<colgroup><col class="row-number-col"/><col class="sr-col"/><col class="ps-col"/><col class="city-col"/><col class="skids-col"/><col class="time-in-col"/><col class="time-out-col"/></colgroup>',
    `<tr><td class="title" colspan="7">${title}</td></tr>`,
    '<tr class="column-header"><th class="row-number">#</th><th>SR #</th><th>PS #</th><th>City / Province</th><th class="skids">Pallets</th><th class="time-entry">Driver&#039;s time in</th><th class="time-entry">Driver&#039;s time out</th></tr>',
    bodyRows,
    `<tr class="summary"><td class="summary-label" colspan="4">Total pallets</td><td class="skids">${palletCount}</td><td class="time-entry"></td><td class="time-entry"></td></tr>`,
    `<tr class="signature"><td class="signature-label" colspan="4">Driver signature <span class="signature-line">&nbsp;</span></td><td class="date-label" colspan="2">Manifest date</td><td class="date-value">${safeShipmentDate}</td></tr>`,
    "</table>",
    "</body>",
    "</html>"
  ].join("");
