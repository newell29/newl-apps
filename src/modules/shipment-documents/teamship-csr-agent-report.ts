...
function renderReportText(report: Omit<GarlandCsrAgentReport, "text" | "html">) {
  ...
  lines.push("Hope this helps,", "Nemo", "Garland CSR Agent", "");
...
function renderReportHtml(report: Omit<GarlandCsrAgentReport, "text" | "html">) {
  return [
    ...
    `<p style="font-size:16px;margin:0 0 8px"><strong>Hello, Nemo reporting for duty.</strong></p>`,
    ...
    `<p style="margin:22px 0 0">Hope this helps,<br><strong>Nemo</strong><br><span style="color:#667085">Garland CSR Agent</span></p>`,
...
function renderNextStepsHtml(nextSteps: string[]) {
  return [
    `<h3 style="margin:20px 0 8px">What Nemo needs from you</h3>`,
