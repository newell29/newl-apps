...
export const SUPPLY_CHAIN_DESIGN_FIELD_LABELS: Record<string, string> = {
  ...
  annual_fixed_cost_currency: "Annual Fixed Cost Currency",
  annual_facility_warehouse_cost: "Annual Facility / Warehouse Cost",
  annual_facility_warehouse_cost_currency: "Annual Facility / Warehouse Cost Currency",
  inbound_fee_per_pallet: "Inbound Fee Per Pallet",
  inbound_fee_per_pallet_currency: "Inbound Fee Per Pallet Currency",
  outbound_fee_per_pallet: "Outbound Fee Per Pallet",
  outbound_fee_per_pallet_currency: "Outbound Fee Per Pallet Currency",
  storage_fee_per_pallet_per_month: "Storage Fee Per Pallet Per Month",
  storage_fee_per_pallet_per_month_currency: "Storage Fee Per Pallet Per Month Currency",
  capacity: "Capacity",
  ...
  current_inventory_value_currency: "Current Inventory Value Currency",
  ...
  transportation_cost_currency: "Transportation Cost Currency",
  mode: "Mode",
  ...
  annual_cost_currency: "Annual Cost Currency",
  currency: "Currency",
  cost_year: "Cost Year",
  notes: "Notes",
  ...
  inventory_value_total_currency: "Inventory Value Currency",
...
> = {
  CURRENT_NETWORK_ACTIVITY: [
    ...
    { field: "transportation_cost_currency", requirement: "OPTIONAL" },
    ...
    { field: "inventory_value_total_currency", requirement: "OPTIONAL" },
  ...
  FACILITIES: [
    ...
    { field: "annual_fixed_cost_currency", requirement: "OPTIONAL" },
    { field: "annual_facility_warehouse_cost", requirement: "OPTIONAL" },
    { field: "annual_facility_warehouse_cost_currency", requirement: "OPTIONAL" },
    ...
    { field: "current_inventory_value_currency", requirement: "OPTIONAL" },
    { field: "currency", requirement: "OPTIONAL" },
  ...
  INVENTORY: [
    ...
    { field: "unit_cost_currency", requirement: "OPTIONAL" },
    { field: "snapshot_date", requirement: "OPTIONAL" }
  ],
  FACILITY_COSTS: [
    { field: "facility_id", requirement: "REQUIRED" },
    ...
    { field: "annual_cost_currency", requirement: "OPTIONAL" },
    { field: "currency", requirement: "OPTIONAL" },
  ...
  CANDIDATE_FACILITIES: [
    ...
    { field: "inbound_fee_per_pallet_currency", requirement: "OPTIONAL" },
    { field: "outbound_fee_per_pallet", requirement: "OPTIONAL" },
    { field: "outbound_fee_per_pallet_currency", requirement: "OPTIONAL" },
    { field: "storage_fee_per_pallet_per_month", requirement: "OPTIONAL" },
    { field: "storage_fee_per_pallet_per_month_currency", requirement: "OPTIONAL" },
    { field: "pallet_capacity", requirement: "OPTIONAL" },
    { field: "capacity", requirement: "OPTIONAL" },
    { field: "currency", requirement: "OPTIONAL" },
    { field: "notes", requirement: "OPTIONAL" },
