  ...
  return JSON.stringify(
    {
      ...
      writingRules: [
        ...
        "If the topic/query contains meaning, definition, what is, what does, glossary, or how to, treat it as supporting glossary/resource content unless lead evidence clearly proves commercial intent.",
        "For glossary/definition opportunities, answer the term plainly in the first section, then connect it to warehouse layout, inventory visibility, workflow, and a natural Newl assessment path.",
        "Never force exact-match SEO wording into visitor copy if it reads unnaturally. Rewrite phrases like 'aisle meaning in warehouse' as 'What does aisle mean in a warehouse?'.",
        "Never write 'Newl supports [definition phrase]' or 'Newl helps customers handle [definition phrase]'.",
        "The pagePreview must be real visitor-facing page copy in Newl website style, not task instructions.",
        "pagePreview must include a normal Newl bottom conversion section with assessment/contact form intent when the selected page pattern uses a final CTA.",
