...
export const config = {
   ...
   */
  matcher: [
    "/((?!api/auth|api/integrations/trademining|api/assistant/teamship/read|api/assistant/openclaw/unresolved-turns|api/assistant/openclaw/development-jobs|api/assistant/openclaw/hunter-quality|api/assistant/teamship/browser-jobs|api/assistant/printing|api/assistant/garland|api/shipment-documents/teamship-review/update-jobs/agent|api/shipment-documents/teamship-review/email-intake/scheduled|api/lead-gen/apollo/status-sync|api/lead-gen/hunter/daily-plan|api/lead-gen/hunter/signal-scout|api/lead-gen/hunter/company-research|api/lead-gen/hunter/outreach-handoff|api/website-growth/scout|api/website-growth/backlinks/executor|api/website-growth/weekly-plan|api/website-growth/build-requests|api/website-inbound|_next/static|_next/image|favicon.ico|.*\\..*).*)"
  ]
};
