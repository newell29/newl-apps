...
export default async function WebsiteGrowthPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Link href="/website-growth/marketing" className="inline-flex rounded-md bg-primary px-4 py-2 text-sm font-semibold text-white">Open Scout marketing workboard →</Link>
